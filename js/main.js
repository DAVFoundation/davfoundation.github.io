              ...
              success: function (data) { 
                ...
                switch(data.statusText) {
                    ...
                    case "Failed":
                        ...
                        $(".kyc-response").html("We ask that you please resubmit your KYC by clicking the button below. Our systems tell us you should be able to successfully complete your KYC by doing the following:<br>" + data.suggestionText);
                    ...
                    case "Rejected":
                        ...
                        $(".kyc-response").html("If you believe your KYC has been rejected by mistake we ask that you please resubmit your KYC by clicking the button below. Our systems tell us you should be able to successfully complete your KYC by doing the following:<br>" + data.suggestionText);
                        $(".kyc-button,.kyc-medium,.kyc-telegram2").removeClass('hide');
